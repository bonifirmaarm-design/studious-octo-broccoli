...
* игра — <http://localhost:8000/web/play.html>
* сцена с двумя Мега-Найтами — <http://localhost:8000/web/>
...
| **Короли** | сидят на королевских башнях и стреляют по подошедшим юнитам |
| **Эликсир** | 1 за 2.8 с, максимум 10, двойной после 2:00 |
| **Матч** | 3 минуты + минута овертайма, победа по коронам или по остатку прочности |
...
| | |
|---|---|
| ![бой](renders/game_fight.png) | ![крупно](renders/game_close2.png) |
| Общий вид матча | Король на башне, мосты, юниты |
