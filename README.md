...
* **Вода — преграда.** Река проходима только по двум мостам; наземные юниты
  строят маршрут через ближний мост, летающие идут напрямую. Положение
  мостов, башен и высота настила сняты с самой модели арены, а не подобраны
  на глаз, поэтому юниты идут по мосту, а не сквозь него.
...
| | |
|---|---|
| ![бой](renders/game_fight.png) | ![крупно](renders/game_fixed.png) |
